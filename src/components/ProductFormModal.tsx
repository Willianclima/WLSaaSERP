      ...
      <div className="relative w-full max-w-4xl bg-white rounded-3xl shadow-2xl border border-stone-200 overflow-hidden flex flex-col max-h-[94vh]">
        ...
        <div className="bg-gradient-to-r from-stone-900 via-stone-800 to-stone-900 text-white p-5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-2xl bg-amber-500/20 border border-amber-400/30 flex items-center justify-center text-amber-400 font-bold font-serif text-lg">
              💎
            </div>
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-stone-400 font-mono">
                  {sku ? `SKU: ${sku}` : "Assistente de Cadastro"}
                </span>
              </div>
              <h3 className="text-lg font-serif font-bold text-white tracking-wide mt-0.5">
                {isEditing ? `Editar: ${name || "Semijoia"}` : "Cadastrar Nova Peça no Catálogo"}
              </h3>
            </div>
          </div>
          <button
        ...
        {/* Navigation Tabs - Assistente em 5 Etapas Intuitivas */}
        <div className="bg-stone-50 border-b border-stone-200 px-6 py-2 flex items-center gap-1.5 overflow-x-auto text-xs font-semibold">
          <button
            type="button"
          ...
          <button
            ...
            className={`px-2.5 py-1.5 rounded-xl transition-all flex items-center gap-1 text-[11px] text-stone-500 hover:text-stone-800 ml-auto cursor-pointer ${
              activeFormTab === "CHARACTERISTICS" ? "bg-stone-200 text-stone-900 font-bold" : ""
            }`}
          >
            <Sparkles className="w-3 h-3 text-amber-500" />
            <span>+ Detalhes do Banho</span>
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-6 flex-1">
          ...
          <div className="pt-4 border-t border-stone-200 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                type="submit"
                className="px-6 py-2.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-stone-950 font-bold text-xs uppercase tracking-wider transition-colors shadow-md flex items-center gap-1.5 cursor-pointer"
              >
                <Check className="w-4 h-4 text-stone-950 stroke-[2.5]" />
                <span>{isEditing ? "Salvar Alterações" : "Salvar e Publicar"}</span>
              </button>
            </div>
          </div>
        </form>
